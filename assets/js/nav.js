  ...
  function initInfoModal() {
    ...
    overlay.innerHTML =
      '<div class="info-modal" role="dialog" aria-modal="true" aria-labelledby="infoModalTitle">' +
        ...
        '<p>I\'m Omid Kheirabadi, born in 1992 in Tehran and now living and working in Rotterdam. I make performance work, and I trained as an interior architect, and both of these keep shaping how I think about power, labor, and the systems we\'re all stuck living inside. I\'m interested in the mechanisms that keep global inequality, borders, and Western dominance in place, and in finding, even briefly, other ways people might exist together. My work moves between performance, participatory workshops, and installations, and it\'s always built around getting people talking to each other rather than just watching. Over the last few years I\'ve been developing performance sessions inspired by Augusto Boal\'s Theatre of the Oppressed and the idea of arte útil, art as something useful rather than just an object. These sessions turn the audience into collaborators, and the hierarchies and habits people carry into a room start to shift the moment they\'re actually asked to take part.</p>' +
        '<p>Projects like Inburgered (MOMO Festival), Alive &amp; Unborn (Delft Fringe, 2023), Bingo Machine (B32, Maastricht, 2024), and Carnisse in Flux (2024) all grew out of this same approach, performance as something made together rather than performed at people. During a four-month residency at the Goethe-Institut I kept refining these sessions, mixing improvisation, collective creation, and open conversation into work built for a specific place and moment. My background in interior architecture still shapes how I think about space and performance together. I\'m always looking at how a room\'s shape quietly tells people how to behave in it, and how to work against that. I hold an MFA in Artistic Research from the Royal Academy of Art in The Hague (2022) and an MA in Interior Architecture from the Maastricht Academy of Architecture (2019).</p>' +
        '<p>I\'ve shown and performed across Europe, in Amsterdam, The Hague, Leuven, Utrecht, Belfast, Maastricht, and Rotterdam. In Zurich, through ZHdK\'s "Performative Interventions" program, I spent an intensive seminar digging further into where resistance to global capitalism and performance art meet. Right now I\'m based at <a href="https://timewindow.nl/" target="_blank" rel="noopener">TimeWindow</a> in Rotterdam, still pushing at the edges between performance, spatial design, and participatory art, trying to open up small spaces where people can imagine things differently together.</p>' +
      '</div>';
    document.body.appendChild(overlay);
