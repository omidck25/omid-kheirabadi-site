  ...
  function initInfoModal() {
    ...
    overlay.innerHTML =
      '<div class="info-modal" role="dialog" aria-modal="true" aria-labelledby="infoModalTitle">' +
        ...
        '<p>I\'m Omid Kheirabadi. I lived most of my life in Tehran and now live and work in Rotterdam. I make performance work, and I trained as an interior architect, and both of these keep shaping how I think about power, labor, and the systems we\'re all stuck living inside. I\'m interested in the mechanisms that keep global inequality, borders, and Western dominance in place, and in finding, even temporarily, other ways people might exist together. My work moves between performance, participatory workshops, and installations, and it\'s always built around the active participation of the audience.</p>' +
        '<p>After finishing my MFA in Artistic Research from the Royal Academy of Art in The Hague (2022), I\'ve spent the last few years developing performance sessions inspired by Augusto Boal\'s Theatre of the Oppressed and the idea of arte útil, art as something with the power of real transformation in the real world. In these sessions, the participants become collaborators.</p>' +
        '<p>During a four-month residency at the Goethe-Institut, I kept refining these sessions, mixing improvisation, collective creation, and open conversation into work built for a specific place and moment.</p>' +
        '<p>My background in architecture shapes how I think about space and performance together. During my MA studies in Interior Architecture at the Maastricht Academy of Architecture (2019), I focused on architecture and its representation as tools of power and dominance that architects traditionally hold and manipulate. I\'m interested in different ways of doing architecture, and in shaping spaces. In our performance sessions, it\'s always interesting to observe how a room\'s shape quietly tells people how to behave in it, and how working against that creates a different kind of space.</p>' +
        '<p>I\'ve shown and performed across Europe, in Amsterdam, Berlin, Istanbul, Utrecht, Leuven, Belfast, The Hague, Maastricht, Sierre, and Rotterdam. In Zurich, through ZHdK\'s "Performative Interventions" program, I spent an intensive seminar digging further into where resistance to global capitalism and performance art meet. Right now I\'m based at <a href="https://timewindow.nl/" target="_blank" rel="noopener">TimeWindow</a> in Rotterdam, still pushing at the edges between performance, spatial design, and participatory art, trying to open up small spaces where people can imagine things differently together.</p>' +
      '</div>';
    document.body.appendChild(overlay);
